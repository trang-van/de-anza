...
Test with Threading - uses multithreading to access APIs and get the data to run the Weather App
...
zip_codes = [92093, 90013, 95192, 94132, 94720, 95064, 95819, 92697, 93940, 94544]  # Global variable for cities
...
class mainWin(tk.Tk):
    def __init__(self):
        ...
        for i in zip_codes:
            url = 'http://api.openweathermap.org/data/2.5/weather?zip='+ str(i)+',us&units=imperial&APPID='+self._appid
        ...
        print('Threading - total elapsed time:', time.time()-start,'s')   # END Timer
